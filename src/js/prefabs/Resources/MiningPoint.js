...
Muryoma.MiningPoint = function (game_state, name, position, properties, ore) {   
    "use strict";  
    
    var height = 96;
    var width = 96;
    var props = {group: 'resources', width: width, height: height, texture: 'ore'};

    Muryoma.Building.call(this, game_state, name, position, props);    
    this.label_units.setText("Ore: " + ore);  
...
Muryoma.MiningPoint.prototype = Object.create(Muryoma.Building.prototype);
...
Muryoma.MiningPoint.prototype.update = function(){
    ...
    if (game.physics.arcade.collide(this, this.game_state.groups.resources, this.collisionHandler, this.processHandler, this)){                     
        this.x = randStep(0, 704, 32);    
        this.y = randStep(0, 408, 32);   
    }        
};
