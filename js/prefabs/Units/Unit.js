...
Muryoma.Unit = function (game_state, name, position, properties) {
    "use strict";
...
Muryoma.Unit.prototype = Object.create(Muryoma.Prefab.prototype);
Muryoma.Unit.prototype.constructor = Muryoma.Unit;

Muryoma.Unit.prototype.receive_damage = function (damage) {
    "use strict";
...
Muryoma.Unit.prototype.restore_tint = function () {
    "use strict";
    this.tint = 0xFFFFFF;
};

Muryoma.Unit.prototype.attack = function (target) {
    "use strict";
    ...
    attack_message = new Muryoma.ActionMessage(this.game_state, this.name + "_action_message", action_message_position, {group: "hud", texture: "rectangle_image", scale: {x: 0.75, y: 0.2}, duration: 1, message: action_message_text});
};